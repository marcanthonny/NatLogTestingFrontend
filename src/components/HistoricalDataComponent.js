...
import './css/HistoricalDataComponent.css';
...
function HistoricalDataComponent({ iraData, ccData, onSnapshotSelect }) {
  ...
  const handleViewSnapshot = async (snapshot) => {
    try {
      ...
      // Pass the snapshot data to parent component
      onSnapshotSelect(fullSnapshot);
      
      // Show confirmation message
      alert('Snapshot loaded! You can now view this data in the Dashboard or Analyze tabs.');
    } catch (error) {
